%%% record at which vessel the simulation stops, so that simplify the
%%% simulation process. For example, for a assigment of 1 1 2 2 3 1 2 2 4 1
%%% stops at vessel number 5 which is assigned to barge number 3, then all
%%% assignments start with 1 1 2 2 3 can be skipped.
