...
%     if max(histcounts(bargeAssign(i,:))) >= threshold || length(find(bargeAssign(i,:) == 4)) >= 3
    if max(histcounts(bargeAssign(i,:))) >= threshold || length(find(bargeAssign(i,:) == 4)) >= 3 || sum(diff([0 find(diff(bargeAssign(i,:))) numel(bargeAssign(i,:))]) >= 4) >= 1 || length(find(bargeAssign(i,:) == 1)) <= 1 || length(find(bargeAssign(i,:) == 2)) <= 1 || length(find(bargeAssign(i,:) == 3)) <= 1
